...
#Realized for inclusion in Annocript
#R CMD BATCH --no-save --no-restore '--args <table> <out image name>  <main name in the table> <x-axys name> <y-axys name> <top n to show>' tables_2_barplot.R
# - Takes in input the table
