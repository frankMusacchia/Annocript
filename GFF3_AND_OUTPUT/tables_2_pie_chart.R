#tables_2_pie_chart.R
#Copyright (C) <2014>  <Francesco Musacchia>
#Realized for inclusion in Annocript 0.2

#
#Creates a piechart using a table given in input which has two columns:
...
jpeg(img_name, width = 1524, height = 768, pointsize = 12, quality = 100, unit = "px") 

#Set the margins of the plot to leave a space on the right
par(mar = c(2, 2, 2, 0), xpd = NA)


#Create the pie
pie(values, col = color_vector, main = main_name,radius=1, labels = descs)
